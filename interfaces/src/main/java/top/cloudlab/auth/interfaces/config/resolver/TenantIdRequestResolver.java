...
import top.cloudlab.auth.interfaces.config.annotation.TenantId;

/**
 * TenantId 参数解析器
 * 从 UserContext 获取当前租户 ID
 */
@Configuration
public class TenantIdRequestResolver implements HandlerMethodArgumentResolver, WebMvcConfigurer {

    @Override
    public boolean supportsParameter(@NonNull MethodParameter parameter) {
        // 只处理带有 @TenantId 注解的参数
